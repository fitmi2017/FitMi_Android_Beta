...
public class FoodLoggingFavSpinnerAdapter extends BaseAdapter {
	...
	public FoodLoggingFavSpinnerAdapter(Context ctx, String[] objects,Integer[] intobj,int bg) {
	...
	public View getCustomView(int position, View convertView, ViewGroup parent) {
		...
		if(FoodLoggingFragment.foodSpinnerSelectFav == position){
