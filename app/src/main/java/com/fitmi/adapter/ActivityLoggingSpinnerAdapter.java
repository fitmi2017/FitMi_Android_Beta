...
public class ActivityLoggingSpinnerAdapter extends BaseAdapter {
	...
	public ActivityLoggingSpinnerAdapter(Context ctx, String[] objects,Integer[] intobj,int bg) {
	...
	public View getCustomView(int position, View convertView, ViewGroup parent) {
		...
		View mySpinner = inflater.inflate(R.layout.activityloggingspinneritem, parent, false);
