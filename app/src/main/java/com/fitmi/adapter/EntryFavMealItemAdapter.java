...
//
//public class EntryFavMealItemAdapter extends ArrayAdapter<Item> {
//
...
//	FitmiFoodLogDAO ei;
//
//	public EntryFavMealItemAdapter(Context context,ArrayList<Item> items) {
