...
public class FoodLoggingRecentSpinnerAdapter extends BaseAdapter {
	...
	public FoodLoggingRecentSpinnerAdapter(Context ctx, String[] objects,Integer[] intobj,int bg) {
	...
	public View getCustomView(int position, View convertView, ViewGroup parent) {
		...
		if(FoodLoggingFragment.foodSpinnerSelectRecent == position){
