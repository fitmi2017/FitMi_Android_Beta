...
public class SleepEditFragment extends BaseFragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_sleep_edit, container, false);
	...
	public void saveSleep()
	{
		...
		Toast.makeText(getActivity(), "Sleep updated", Toast.LENGTH_LONG).show();
	}
