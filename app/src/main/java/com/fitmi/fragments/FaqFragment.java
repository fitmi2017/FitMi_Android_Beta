...
public class FaqFragment extends BaseFragment{
	...
	public View onCreateView(LayoutInflater inflater,
		...
		webViewFaq.setScrollBarStyle(WebView.SCROLLBARS_OUTSIDE_OVERLAY);
		  
	        if (Build.VERSION.SDK_INT >= 19) {
	        	webViewFaq.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
	        }
		...
		webViewFaq.loadUrl("http://fitmi.com/#FAQ");
