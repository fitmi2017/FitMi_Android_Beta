...
import com.fitmi.activitys.SignUpActivity;
...
/*	@InjectView(R.id.DailyCalorieIntake)
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		/*	}else{
				int inft,_meter=0;
				double _total,_cm=0,ininch=0.0,_final=0.0;
				...
				_meter= (int) (_total/100);
				_cm= (_total%100);
				DecimalFormat formatter = new DecimalFormat("##.##");
				String finalmeter = formatter.format(_meter);
				String finalcm = formatter.format(_cm);
				
				feet.setText(finalmeter);
				inches.setText(finalcm);
...
/*		lastName.setOnEditorActionListener(new TextView.OnEditorActionListener(){
	        ...
	        public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
	                ...
	                && (event.getKeyCode() == KeyEvent.KEYCODE_ENTER))
	            {
	                ...
	                imm.hideSoftInputFromWindow(feet.getWindowToken(), 0);
	                Toast.makeText(getActivity(), "My message", Toast.LENGTH_SHORT).show();
	            }
				return true;
	       }
	});*/
