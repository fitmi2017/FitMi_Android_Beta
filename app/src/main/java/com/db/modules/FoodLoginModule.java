...
import com.fitmi.utils.NotifyDatachangeDateselect;
...
public class FoodLoginModule extends BaseModule{
	...
	public static void insertFitmifoodTable(FitmiFoodDAO fitmiFoodData,DatabaseHelper helper)
	{
		...
		Log.e("Printing insertFitmifoodTable value ","name "+fitmiFoodData.getItemName()+" Calories "+fitmiFoodData.getNfCalories()+" serving wt "+fitmiFoodData.getNfServingWeightGrams()+" Item Id "+fitmiFoodData.getItemId());
	...
	public static void insertFitmifoodTable(String name,String calorie,String _id,String NfServingWeightGrams,String itemDesc,DatabaseHelper helper, Context ctx)
	{
		...
		Log.e("Printing insertFitmifoodTable value ","name "+name+" Calories "+calorie+" serving wt "+NfServingWeightGrams+" Item Id "+_id);
	...
	public static void insertFitmifoodLogTable(FitmiFoodLogDAO fitmiFoodLogData,DatabaseHelper helper)
	{
		...
		String queryString = "INSERT INTO fitmi_food_log ("+
				"user_id, user_profile_id, meal_id, food_name, description, cals, serving_size, reference_food_id, log_time,gm_calorie,isFavMeal, date_added ) VALUES ("+
				...
				fitmiFoodLogData.getCalory()+"', '"+fitmiFoodLogData.getServingSize()+"', '"+fitmiFoodLogData.getReferenceFoodId()+"', '"+
 ...
 */
	...
	//added by avinash
	public static void editCaloryItew(String id,DatabaseHelper helper,String calory,String weight)
	{
		SQLiteDatabase db = helper.getWritableDatabase();
